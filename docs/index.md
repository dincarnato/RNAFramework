...
!!! warning "Important"
    __[01-17-2017] Major bug fixes:__<br/>__1.__ When ``rf-count`` was used in mutation count mode, deletions were shifted downstream by 1 nt<br/>__2.__ When ``rf-count`` calculates reference coverage, additional coverage was erroneously added to the base following read's end mapping position<br/>__3.__ In mutation count and coverage only modes, reads mapping to the reverse strand were erroneously discarded
