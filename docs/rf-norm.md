The RF Norm module takes one (Rouskin and Zubradt methods), or two (Ding method) RC files generated by the RF Count module, and performs normalization to obtain transcriptome-wide per-base reactivities.<br/>Reactivity scores can be computed using 3 methods:
<br/><br/>
...
__[3] Zubradt *et al*., 2016 (PMID: [27819661](https://www.ncbi.nlm.nih.gov/pubmed/27819661))__<br/><br/>
...
----------------: | :--: |:------------
__-u__ *or* __--untreated__ | string | Path to the RC file for the non-treated/denatured (or RNase V1) sample <br/>(required by Ding scoring method)
...
__-o__ *or* __--output-dir__ | string | Output directory for writing normalized data in XML format (Default: __&lt;treated&gt;\_vs\_&lt;untreated&gt;\_norm/__ for Ding method, __&lt;treated&gt;\_norm/__ for Rouskin/Zubradt methods)
...
__-sm__ *or* __--scoring-method__ | int | Method for score calculation (1-4, Default: __1__):<br/>__1.__ Ding *et al.*, 2014 <br/>__2.__ Rouskin *et al.*, 2014 <br/>__3.__ Zubradt *et al.*, 2016
...
__-nw__ *or* __--norm-window__ | int | Window size (in nt) for signal normalization (&ge;3, Default: __whole transcript__ [Ding], __50__ [Rouskin; Zubradt])
__-wo__ *or* __--window-offset__ | int | Offset (in nt) for window sliding during normalization (Default: __none__ [Ding], __50__ [Rouskin; Zubradt])
...
-------------: | :------------:  | :------------
__scoreMethod__ | "Ding" (or 1); "Rouskin" (or 2); "Zubradt" (or 3) | __Ding__
...
__normWindow__ | Positive integer &ge; 3 | __1e9__ [Ding]<br/>__50__ [Rouskin; Zubradt]
__windowOffset__ | Positive integer &gt; 0 | __1e9__ [Ding]<br/>__50__ [Rouskin; Zubradt]
...
__scoring__ | Ding, Rouskin, or Zubradt | Scoring method
